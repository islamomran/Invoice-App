...
/* harmony import */ var _progress_kendo_angular_buttons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @progress/kendo-angular-buttons */ "./node_modules/@progress/kendo-angular-buttons/dist/fesm2015/index.js");
/* harmony import */ var _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/platform-browser/animations */ "./node_modules/@angular/platform-browser/fesm2015/animations.js");
/* harmony import */ var _progress_kendo_angular_dateinputs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @progress/kendo-angular-dateinputs */ "./node_modules/@progress/kendo-angular-dateinputs/dist/fesm2015/index.js");
...
let InvoiceService = class InvoiceService {
    ...
    uploadSinglePageInvoices(form, urls) {
    ...
    uploadMultiPageInvoices(form, urls) {
        return this._http.post(`${this._url}/invoice`, {
            invoiceDate: form.date,
            imageUrls: urls
        }, { responseType: 'text' });
...
let Step2Component = class Step2Component {
    constructor(_location, formBuilder, _invoiceservice, router) {
    ...
    upload() {
        this.uppy.upload().then((res) => {
            if (res.failed.length != 0) {
                window.alert(`Failed to upload ${res.failed.length} files.`);
                return;
            }
            let sub = null;
            if (this.formData.invoice_type == "single") {
                sub = this._invoiceservice.uploadSinglePageInvoices(this.formData, res.successful.map(r => r.uploadURL)).toPromise();
            }
            else {
                sub = this._invoiceservice.uploadMultiPageInvoices(this.formData, res.successful.map(r => r.uploadURL)).toPromise();
            }
            sub.then(() => {
    ...
    updateIsUploadValid(filesUploadedCount) {
